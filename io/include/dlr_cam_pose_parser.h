#ifndef _DLR_CAM_POSE_PARSER_H_
#define _DLR_CAM_POSE_PARSER_H_
...
namespace fi
{
	...
	public:
		...
		*/
		DLRCamPOSEParser(const std::string &mshr_pose_dir, const std::vector<std::vector<unsigned int> > image_names);

		DLRCamPOSEParser(const std::string &mshr_pose_dir, const std::vector<std::string> image_names);

		//Destructor
		virtual ~DLRCamPOSEParser();
