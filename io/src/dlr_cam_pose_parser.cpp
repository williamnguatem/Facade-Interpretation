...
fi::DLRCamPOSEParser::DLRCamPOSEParser()
{

}

fi::DLRCamPOSEParser::DLRCamPOSEParser(const std::string &mshr_pose_dir, const std::vector<std::vector<unsigned int> > image_names)
...
bool fi::DLRCamPOSEParser::getCamPose(std::vector<std::vector<Eigen::Matrix3f> > &rotation_matrix, 
...
void fi::DLRCamPOSEParser::getCamRotationMatrix(const boost::filesystem::path &pose_file, Eigen::Matrix3f &rotation_matrix)
{
	std::string a_line;
...
void fi::DLRCamPOSEParser::getCamTranslationVector(const boost::filesystem::path &pose_file, Eigen::Vector3f &translation_vector)
{
...
void fi::DLRCamPOSEParser::getRadialDistortionParams(const boost::filesystem::path &pose_file, float &radial_distortion_param_k1, float &radial_distortion_param_k2)
{
	std::string a_line;
...
unsigned int fi::DLRCamPOSEParser::getImageWidth(const boost::filesystem::path &pose_file)
{
	std::string a_line;
	unsigned int num_lines = 0; // the radial distortion params is on the 6 and 7th line!
	//std::ifstream param_file ("E:\\21\\Result\\UniBW\\10884_param.txt");
...
unsigned int fi::DLRCamPOSEParser::getImageHeight(const boost::filesystem::path &pose_file)
{
	std::string a_line;
	unsigned int num_lines = 0; // the radial distortion params is on the 6 and 7th line!
	//std::ifstream param_file ("E:\\21\\Result\\UniBW\\10884_param.txt");
